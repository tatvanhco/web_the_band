    ...
    <div class="container" id="suasp">
      ...
      ?>
                  <tr>
                    ...
                    <td><button type="button" class="btn btn-danger btn-lg" id="delete"><a href="delete.php?id_delete=<?php echo $data["IDSP"]; ?>">Xóa</button></a></td>
                  </tr>
                <?php
                  }
                  //xu ly xoa 
                  ...
                  if (isset($_GET["id_delete"])) {
                      $sql = "DELETE FROM sanpham WHERE IDSP = ".$_GET["id_delete"];
