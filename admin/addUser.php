...
<div class="container">
    <h2>THÊM TÀI KHOẢN MỚI</h2>
                <form action="./xulythemUser.php" method="POST">
                    <div class="form-group">
                        Tên tài khoản: <input type="text" class="form-control" placeholder="Tên tài khoản" name="nameID" required>
                    </div>

                    <div class="form-group">
                        Tên: <input type="text" class="form-control" placeholder="Tên" name="name" required>
                    </div>

                    <div class="form-group">
                        Email: <input type="text" class="form-control" placeholder="Email" name="email" required>
                    </div>
                    <div class="form-group">
                        Password: <input type="text" class="form-control" placeholder="Password" name="password" required>
                    </div>
