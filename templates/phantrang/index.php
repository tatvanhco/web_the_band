...
<body>
	...
	<div class="wrap" style="clear: both;">
		...
		$sql="SELECT * FROM sanpham ORDER BY IDSP ASC LIMIT ".$item_per_page." OFFSET ".$offset."";
		...
		while($row=mysqli_fetch_array($result)){ 
			...
			<div>
				...
				<p>
					<button><a href="/do_an_co/templates/giohang/cart.php?id=<?php echo $row['IDSP']?>" style="text-decoration: none; " class="link-product-add-cart">Mua Ngay</a></button>
				</p>
			</div> 
